...
THREE.TrackballControls = function(object, domElement) {
	...
	this.update = function() {
		...
		if (_this.object === undefined || this.object === null)
			return;
	...
	this.attach = function(object) {
		...
		_this.position0 = this.object.position.clone();
		_this.up0 = this.object.up.clone();
	};

	this.detach = function() {

		_this.domElement.removeEventListener('contextmenu', suppressContextMenu);
		...
		_this.position0 = new THREE.Vector3();
		_this.up0 = new THREE.Vector3();
